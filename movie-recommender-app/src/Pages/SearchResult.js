...
const SearchResult = () => {
    ...
    const gotRecommendedData = (apiData) => {
        ...
        for (let movie of apiData.movies) {
            fetch(
                `https://api.themoviedb.org/3/search/movie?api_key=b97316ed479ee4226afefc88d1792909&query=${movie}`
            ).then((Response) =>
    ...
    useEffect(
        () => {
            const gotTMDBData = (apiData) => {
                ...
                fetch(
                    `https://api.themoviedb.org/3/movie/${realMovieData.id}/credits?api_key=b97316ed479ee4226afefc88d1792909`
                ).then((Response) =>
                    Response.json().then((data) => gotCast(data.cast))
                );

                fetch(
                    `https://api.themoviedb.org/3/movie/${realMovieData.id}?api_key=b97316ed479ee4226afefc88d1792909&append_to_response=videos`
                ).then((Response) =>
            ...
            fetch(
                `https://api.themoviedb.org/3/search/movie?api_key=b97316ed479ee4226afefc88d1792909&query=${inputValue}`
            ).then((Response) =>
